...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BleepAction) DeepCopyInto(out *BleepAction) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BleepAction.
func (in *BleepAction) DeepCopy() *BleepAction {
	if in == nil {
		return nil
	}
	out := new(BleepAction)
